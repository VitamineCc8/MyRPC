...
public final class CuratorUtils {
    ...
    /**
     * 主要做两件事，一是在zookeeper客户端中创建PERSISTENT类型的节点，二是在REGISTERED_PATH_SET中加入服务路径
     */
    ...
    /**
     * clearRegistry清理服务器在zookeeper客户端中的服务地址。如果Set中以IP地址+端口号结尾，则在zookeeper客户端中删去这个服务名的地址。
     */
    public static void clearRegistry(CuratorFramework zkClient, InetSocketAddress inetSocketAddress) {
        REGISTERED_PATH_SET.stream().parallel().forEach(p -> {
            try {
                //在服务器运行时，IP地址，那么钩子函数将不能在zookeeper客户端中删除结点，去除if判断既可以
...
//                }
    ...
    /**
     * 获得zookeeper客户端，如果能够连接zk客户端，则返回，如果未连接成功，尝试一次新连接，等待30s失败后抛出异常
     */
